document.addEventListener("DOMContentLoaded", () => {
  ...
  function buyButtonClicked() {
    ...
    let orderData = {
      ...
      sandwich: 0,
      mellombar: 0,
      total: document.querySelector(".total-price").innerText.replace("₹", "")
    };
    ...
    alert("Order placed successfully! You will soon receive a ");
  ...
  function sendOrderData(orderData) {
    fetch("https://sheetdb.io/api/v1/ewz9hfwoq4yl0", {
      method: "POST",
      headers: {
